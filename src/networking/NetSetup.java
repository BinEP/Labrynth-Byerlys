...
//        final String[] choices = {"A", "B"};
        ...
        final String[] choices = ScanNetwork.checkHostsAtPort(DEFAULT_PORT);
...
//                    new GoFishWindow("localhost", port);
                	return setupNetworkManager("localhost", port);
...
//                    new GoFishWindow(host,port);
                	return setupNetworkManager(host, port);
...
//                  hostInput.selectAll();
    ...
    private static NetworkManager setupNetworkManager(String host, int port) throws IOException {
